...
export default function Home() {
  ...
  return (
    <div className="max-w-7xl flex flex-col mx-auto gap-6 h-auto">
        ...
        <div className='bg-gris-muy-claro w-full px-5 py-12 rounded-lg flex flex-col gap-6 h-full'>
            ...
            <nav className="flex flex-col w-1/4 gap-4 mx-auto">
                ...
                <a
                    className={`isolate relative z-10 w-full text-center rounded border-2 border-[#0088CC] bg-[#0088CC]/85 px-5 py-2 text-sm font-medium uppercase text-white transition-colors before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-[#0088CC] before:transition-transform before:duration-300 before:content-[''] hover:text-white before:hover:scale-x-100 active:brightness-110`}
                    href={'https://vidayfortaleza.com'}
